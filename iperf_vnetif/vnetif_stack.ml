 ...
 * Copyright (c) 2025 Takayuki Imada <takayuki.imada@gmail.com>
 *
...
(* This file was ported from the mirage-vnetif-stack package. *)
...
module Vnetif_stack (B : Vnetif.BACKEND):
...
struct
  ...
  module T = Tcp.Flow.Make(Ip)
  module V4V6 = Tcpip_stack_direct.MakeV4V6(V)(E)(A)(Ip)(Icmp)(U)(T)
